...
import { IAction, IFileRef, IStep } from 'cl-sdk/types';
import { addMessage } from 'cl-sdk/utils/message';
...
const uuidv4 = () => {
  // return "dksa"
  // const uuidResult:string = uuid.v4().toString();
  const uuidResult = randomUUID();
  console.error('useChatInteract',uuidResult);
  return uuidResult;
};
